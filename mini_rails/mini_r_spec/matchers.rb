...
module MiniRSpec
  # NOTE: Matcher object
  # Under the hood expect(1).to eq(1) is EqMatcher.new(1) == Matcher.new(1)
  # expect(1).not_to eq(2) is EqMatcher.new(2) != Matcher.new(1)
  # expect(1).to be_present is BePresentMatcher.new == Matcher.new(1)
  class Matcher
